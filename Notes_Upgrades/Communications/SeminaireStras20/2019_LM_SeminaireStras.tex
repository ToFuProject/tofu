...
\addbibresource{2019_LM_SeminaireStras.bib}
\usepackage{hyperref}
...
\frametitle{Tokamak diagnostics to measure plasma quantities}
	\begin{center}
		\includegraphics[width=0.7\textwidth]{figures/ITER.pdf}
	\end{center}
\end{frame}
% =================================
...
\begin{table}[h] % just use this specifier if really needed.
	...
	\sisetup{round-mode=places}
     \begin{tabular}{@{}lllll@{}}
       ...
       hybrid & 0.08 & 0.44 & 4.32 & 40.3 (32Gb) \\%& 612 (32Gb)\\
...
\begin{center}
	\includegraphics[width=0.75\linewidth]{figures/meshes.png}
	\includegraphics[width=0.15\linewidth]{figures/maillage3.png}
