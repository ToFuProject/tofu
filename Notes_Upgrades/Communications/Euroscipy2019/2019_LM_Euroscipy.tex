...
% =================================
\begin{frame}
\frametitle{Context: energy needs vs climate change}
...
Energy needs are growing (population, standards of living...)
\tab $\Rightarrow$ high pressure on our environment (degraded,

Current solutions present some drawbacks:
\begin{itemize}%[leftmargin=1em]
	\item limited or intermittent resources
	\item significant production of green house gases or radioactive waste
	\item low availability without long-term mass storage solution
	\item unequal geographical distribution of resources
	\item industrial risks (nuclear, chemical...)
\end{itemize}
...
\begin{columns}
	...
	\end{column}
		\begin{column}{0.33\textwidth}
		\begin{center}
		\textbf{1D Camera with reflexions}
		\includegraphics[width=\textwidth]{figures/cam1d_ref.png}
	\end{center}
		\end{column}
		\pause
		\begin{column}{0.33\textwidth}
		\begin{center}
		\textbf{2D Camera with reflexions}
		\includegraphics[width=\textwidth]{figures/cam2d_ref.png}
	\end{center}	
		\end{column}
	\end{columns}
\end{frame}
