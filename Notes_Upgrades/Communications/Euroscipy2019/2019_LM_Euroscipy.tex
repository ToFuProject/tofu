...
$\quad \Rightarrow$ decrease consumption + alternative production means\\

$\quad \Rightarrow$ relatively clean, safe, mass-production means with large resources would be welcome in the mix\\
...
$\quad \Rightarrow$ pinhole cameras (1D or 2D) for measuring light in various wavelengths
...
\begin{itemize}
	\item Meshing and Basis functions with visualization
	\item Multiple Inversion-Regularization and visualization
	\end{itemize}
%\begin{center}
