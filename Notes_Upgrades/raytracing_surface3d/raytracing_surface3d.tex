...
\begin{array}{llll}
    ...
    (2k-1)r\OEz
    - (2k-1)(\OA\cross\z)^2
    + 2kl(\OA\cross\z)\cdot(\ez)(1 - k - 2k + 1)
    + k^2l^2(\ez)^2(2 - 2k - 2k + 1) & = 0\\
    
    & \Leftrightarrow &
    (2k-1)r\OEz
    - (2k-1)(\OA\cross\z)^2
    + 2kl(\OA\cross\z)\cdot(\ez)(2 - 3k)
    + k^2l^2(\ez)^2(3 - 4k) & = 0\\
    
    & \Leftrightarrow &
    (2k-1)r\OEz = (2k-1)(\OA\cross\z)^2
    - 2kl(\OA\cross\z)\cdot(\ez)(2 - 3k)
    - k^2l^2(\ez)^2(3 - 4k)\\
    ...
    + (2k-1)^2r^2k^2l^2(\ez)^2\\
    && = (2k-1)^2(\OA\cross\z)^4
    - 2(2k-1)(\OA\cross\z)^22kl(\OA\cross\z)\cdot(\ez)(2 - 3k)
    - 2(2k-1)(\OA\cross\z)^2k^2l^2(\ez)^2(3 - 4k)\\
    && + 4k^2l^2\left((\OA\cross\z)\cdot(\ez)\right)^2(2 - 3k)^2
    + k^4l^4(\ez)^4(3 - 4k)^2
    + 4kl(\OA\cross\z)\cdot(\ez)(2 - 3k)k^2l^2(\ez)^2(3 - 4k)\\
    
    & \Leftrightarrow &
    (2k-1)^2A + k(2k-1)^2B + k^2(2k-1)^2C\\
    && = - k(2k-1)(2 - 3k)D - k^2(2k-1)(3 - 4k)E + k^2(2 - 3k)^2F
    + k^4(3 - 4k)^2G + k^3(2 - 3k)(3 - 4k)H\\
    
    & \Leftrightarrow &
    k^6(-16G)\\
    && + k^5(-12H + 24G)\\
    && + k^4(8H + 9H - 9G - 9F - 8E + 4C)\\
    && + k^3(-6H + 12F + 6E + 4E - 6D - 4C + 4B)\\
    && + k^2(-4F - 3E + 4D + 3D + C - 4B + 4A)\\
    && + k(-2D + B -4A)\\
    && + A = 0\\
    ...
    && + k^5(-12H + 24G)\\
    && + k^4(17H - 9G - 9F - 8E + 4C)\\
    && + k^3(-6H + 12F + 10E - 6D - 4C + 4B)\\
    && + k^2(-4F - 3E + 7D + C - 4B + 4A)\\
    && + k(-2D + B -4A)\\
    && + A = 0
\end{array}
$$
...
\begin{array}{llll}
    ...
    C = r^2l^2(\ez)^2\\
    D = 4l(\OA\cross\z)^2(\OA\cross\z)\cdot(\ez)\\
    E = 2l^2(\OA\cross\z)^2(\ez)^2\\
    F = 4l^2\left((\OA\cross\z)\cdot(\ez)\right)^2\\
    G = l^4(\ez)^4\\
    H = 4l^3(\OA\cross\z)\cdot(\ez)(\ez)^2
\end{array}
\right.
$$
...
\begin{array}{llll}
    ...
    + k^3\left[ -4C_1 + 4C_2 - 2C_3  \right]
    + k^2\left[ 4C_0 + C_1 - 4C_2  + C_3 \right]
    + k\left[ -4C_0 + C_2 \right]
    + C_0 = 0\\
\end{array}
$$
