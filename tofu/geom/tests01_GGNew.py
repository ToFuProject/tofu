...
def test03_Ves_mesh_CrossPoly(VPoly=VPoly):
    ...
    PtsCross, dLr, ind, N, Rref, VPbis = GG._Ves_mesh_CrossPoly(VPoly, dL, D1=None, D2=None, margin=1.e-9, DIn=0., VIn=VIn)
    ...
    PtsCross, dLr, ind, N, Rref, VPbis = GG._Ves_mesh_CrossPoly(VPoly, dL, D1=[0.,2.], D2=[-2.,0.], margin=1.e-9, DIn=0.05, VIn=VIn)
