...
def _getBoundsInter2AngSeg(bool Full, double Phi0, double Phi1, double DPhi0,
                           double DPhi1):
    """ Return Inter=True if an intersection exist (all angles in radians in
    [-pi;pi])
...
def LOS_Calc_PInOut_VesStruct(Ds, dus,
                              ...
                              EpsA=1.e-9, EpsB=1.e-9, EpsPlane=1.e-9,
                              VType='Tor', Test=True):
