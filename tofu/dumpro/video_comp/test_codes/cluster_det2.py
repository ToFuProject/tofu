...
#######################################################################
#   Getting user option on displaying
#######################################################################
...
#######################################################################
#   Gathering meta_data information
#######################################################################
    #getting inforamtion on meta_data        
    if meta_data == None:
...
#######################################################################
#   Croping and slicing video according to user input
#######################################################################
...
#######################################################################
#   Background subtraction method declaration
#######################################################################    
...
#######################################################################
    ...
    while cap.isOpened():
        ...
        #slicing in time
        if (frame_counter >= start and frame_counter <= stop):
...
#######################################################################        
            ...
            if user_choice == 'y':
                if ('7' in user_option):
                    ...
                    if cv2.waitKey(25) & 0xFF == ord('q'): 
                        break
            name = 'E:/NERD/images/'+'frame'+str(frame_counter)+'.jpg'
