...
dtransitions = {
    'Li-like': {
        ...
        'q': ['1s^22s(^2S_{1/2})', '1s2s2p(^1P)(^2P^0_{3/2})'],
        'r': ['1s^22s(^2S_{1/2})', '1s2s2p(^1P)(^2P^0_{1/2})'],
        # 1s^22s(^2S) - 1s2s2p(^3P)(^2P^0)
        's': ['1s^22s(^2S_{1/2})', '1s2s2p(^3P)(^2P^0_{3/2})'],
        't': ['1s^22s(^2S_{1/2})', '1s2s2p(^3P)(^2P^0_{1/2})'],
...
dlines = {
    ...
    'FeXXIV_t': {'q': 23, 'ION': 'FeXXIV',
                 'lambda': 1.8566e-10,
                 'transition': ('Li-like', 't'),
                 'source': 'Bitter'},
    'FeXXIV_q': {'q': 23, 'ION': 'FeXXIV',
                 'lambda': 1.8605e-10,
                 'transition': ('Li-like', 'q'),
                 'source': 'Bitter'},
    'FeXXIV_k': {'q': 23, 'ION': 'FeXXIV',
                 'lambda': 1.8626e-10,
                 'transition': ('Li-like', 'k'),
                 'source': 'Bitter'},
    'FeXXIV_r': {'q': 23, 'ION': 'FeXXIV',
                 'lambda': 1.8631e-10,
                 'transition': ('Li-like', 'r'),
                 'source': 'Bitter'},
    'FeXXIV_j': {'q': 23, 'ION': 'FeXXIV',
                 'lambda': 1.8654e-10,
                 'transition': ('Li-like', 'j'),
                 'source': 'Bitter'},

    'FeXXV_w': {'q': 24, 'ION': 'FeXXV',
                'lambda': 1.8498e-10,
                'transition': ('He-like', 'w'),
                'source': 'Bitter'},
    'FeXXV_x': {'q': 24, 'ION': 'FeXXV',
                'lambda': 1.85503e-10,
                'transition': ('He-like', 'x'),
                'source': 'Bitter'},
    'FeXXV_y': {'q': 24, 'ION': 'FeXXV',
                'lambda': 1.8590e-10,
                'transition': ('He-like', 'y'),
                'source': 'Bitter'},
    'FeXXV_z': {'q': 24, 'ION': 'FeXXV',
                'lambda': 1.8676e-10,
                'transition': ('He-like', 'z'),
                'source': 'Bitter'},
}
