...
dlines = {
    ...
    'ArXVI_m': {'Z': 18, 'q': 15, 'element': 'Ar', 'ION': 'ArXVI',
                ...
                'source': 'Kallne'},
    'ArXVI_m_NIST': {'Z': 18, 'q': 15, 'element': 'Ar', 'ION': 'ArXVI',
                     'symbol': 'm', 'lambda': 3.96561e-10,
                     'transition': [r'$1s2p^2(^2S_{1/2})$', r'$1s^22p(^2P_{3/2})$'],
                     'source': 'NIST'},
    'ArXVI_s': {'Z': 18, 'q': 15, 'element': 'Ar', 'ION': 'ArXVI',
                ...
                'source': 'Kallne'},
    'ArXVI_s_NIST': {'Z': 18, 'q': 15, 'element': 'Ar', 'ION': 'ArXVI',
                     'symbol': 's', 'lambda': 3.9976e-10,
                     'transition': [r'$1s2s2p(^1P)^2P_{3/2}$', r'$1s^22s(^2S_{1/2})$'],
                     'source': 'NIST'},
    'ArXVI_t': {'Z': 18, 'q': 15, 'element': 'Ar', 'ION': 'ArXVI',
                ...
                'source': 'Kallne'},
    'ArXVI_t_NIST': {'Z': 18, 'q': 15, 'element': 'Ar', 'ION': 'ArXVI',
                     'symbol': 't', 'lambda': 3.9685e-10,
                     'transition': [r'$1s2s2p(^1P)^2P_{1/2}$', r'$1s^22s(^2S_{1/2})$'],
                     'source': 'Kallne'},
    'ArXVI_q': {'Z': 18, 'q': 15, 'element': 'Ar', 'ION': 'ArXVI',
                ...
                'transition': [r'$1s2s2p(^1P)^2P_{3/2}$', r'$1s^22s(^2S_{1/2})$'],
                'source': 'Kallne', 'innershell': True},
    'ArXVI_q_NIST': {'Z': 18, 'q': 15, 'element': 'Ar', 'ION': 'ArXVI',
                     'symbol': 'q', 'lambda': 3.9806e-10,
                     'transition': [r'$1s2s2p(^1P)^2P_{3/2}$', r'$1s^22s(^2S_{1/2})$'],
                     'source': 'Kallne', 'innershell': True},
    ...
    'ArXVI_k_NIST': {'Z': 18, 'q': 15, 'element': 'Ar', 'ION': 'ArXVI',
                     'symbol': 'k', 'lambda': 3.9898e-10,
                     'transition': [r'$1s2p^2(^2D_{3/2})$', r'$1s^22p(^2P_{1/2})$'],
    ...
    'ArXVII_w': {'Z': 18, 'q': 16, 'element': 'Ar', 'ION': 'ArXVII',
                 ...
                 'source': 'Kallne'},
    'ArXVII_w_NIST': {'Z': 18, 'q': 16, 'element': 'Ar', 'ION': 'ArXVII',
    ...
    'ArXVII_x': {'Z': 18, 'q': 16, 'element': 'Ar', 'ION': 'ArXVII',
                 ...
                 'source': 'Kallne'},
    'ArXVII_x_NIST': {'Z': 18, 'q': 16, 'element': 'Ar', 'ION': 'ArXVII',
                      'symbol': 'x', 'lambda': 3.965857e-10,
                      'transition': [r'$1s2p(^3P_2)$', r'$1s^2(^1S_0)$'],
                      'source': 'NIST'},
    'ArXVII_y': {'Z': 18, 'q': 16, 'element': 'Ar', 'ION': 'ArXVII',
                 ...
                 'source': 'Kallne'},
    'ArXVII_y_NIST': {'Z': 18, 'q': 16, 'element': 'Ar', 'ION': 'ArXVII',
                      'symbol': 'y', 'lambda': 3.969355e-10,
                      'transition': [r'$1s2p(^3P_1)$', r'$1s^2(^1S_0)$'],
                      'source': 'Kallne'},
    'ArXVII_z': {'Z': 18, 'q': 16, 'element': 'Ar', 'ION': 'ArXVII',
                 ...
                 'source': 'Kallne'},
    'ArXVII_z_NIST': {'Z': 18, 'q': 16, 'element': 'Ar', 'ION': 'ArXVII',
