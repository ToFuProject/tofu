...
# extra_compile_args = ["-O3", "-Wall", "-fno-wrapv", "-ffast-math", "-fsignaling-nans"] + openmp_flag
extra_compile_args = ["-O0", "-g", "-Wall", "-fno-wrapv", "-ffast-math", "-fsignaling-nans"] + openmp_flag
