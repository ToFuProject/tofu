...
See:
https://didou09.github.io/tofu/index.html
https://github.com/Didou09/tofu
"""
...
setup(
    ...
    url='https://github.com/Didou09/tofu',
    ...
    packages=find_packages(exclude=['doc', '_Old', '_Old_doc', 'tests']),
